...
U 1 1 606DF59D
P 9950 900
F 0 "#PWR01" H 9950 750 50  0001 C CNN
F 1 "+5V" H 9950 1050 50  0000 C CNN
...
U 1 1 606B6E4F
P 10000 2800
F 0 "J1" H 10350 4700 50  0000 C CNN
F 1 "ECB_Kontron" H 10350 4600 50  0000 C CNN
F 2 "rackz80_footprints:Eurocard_DIN41612_C64_Male" H 9950 4150 50  0001 C CNN
F 3 "http://2jo.de/robotron/Kontron/KONz80.pdf" H 9950 4150 50  0001 C CNN
	1    10000 2800
	1    0    0    -1  
$EndComp
...
F 1 "74LS138" H 4750 6200 50  0000 C CNN
F 2 "rackz80_footprints:DIP-16_Socket" H 4500 5700 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74LS138" H 4500 5700 50  0001 C CNN
	1    4500 5700
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 61478310
P 4500 5050
F 0 "#PWR019" H 4500 4900 50  0001 C CNN
...
U 1 1 61478D15
P 4500 6450
F 0 "#PWR030" H 4500 6200 50  0001 C CNN
...
U 1 1 61700DF7
P 1350 1300
F 0 "R3" H 1280 1254 50  0000 R CNN
F 1 "1k" H 1280 1345 50  0000 R CNN
F 2 "Resistor_THT:R_Axial_DIN0207_L6.3mm_D2.5mm_P10.16mm_Horizontal" V 1280 1300 50  0001 C CNN
...
U 1 1 616E300C
P 850 1300
F 0 "R1" H 780 1254 50  0000 R CNN
F 1 "1k" H 780 1345 50  0000 R CNN
F 2 "Resistor_THT:R_Axial_DIN0207_L6.3mm_D2.5mm_P10.16mm_Horizontal" V 780 1300 50  0001 C CNN
...
U 1 1 616E1894
P 1100 1300
F 0 "R2" H 1030 1254 50  0000 R CNN
F 1 "1k" H 1030 1345 50  0000 R CNN
...
Entry Wire Line
	5400 2900 5500 2800
$Sheet
S 4100 3700 1050 700 
U 61171ACF
F0 "Memory Logic" 50
F1 "MemoryLogic.sch" 50
F2 "D[0..7]" I L 4100 4100 50 
F3 "~CS" I R 5150 4300 50 
F4 "~RESET" I R 5150 4200 50 
F5 "B[0..3]" O R 5150 3800 50 
F6 "A15" I L 4100 4200 50 
F7 "~ROM_CS" O L 4100 3900 50 
F8 "~MRQ" I R 5150 4100 50 
F9 "~RAM_CS" O R 5150 3900 50 
$EndSheet
Wire Bus Line
	5400 750  5100 750 
Connection ~ 5400 750 
...
U 1 1 606ED23E
P 6100 1050
F 0 "#PWR06" H 6100 900 50  0001 C CNN
...
U 1 1 606ECBF4
P 4400 1050
F 0 "#PWR05" H 4400 900 50  0001 C CNN
...
F 1 "28C256" H 4650 3300 50  0000 C CNN
F 2 "rackz80_footprints:DIP-28_Socket_Wide" H 4400 2200 50  0001 C CNN
F 3 "http://ww1.microchip.com/downloads/en/DeviceDoc/doc0006.pdf" H 4400 2200 50  0001 C CNN
	1    4400 2200
	1    0    0    -1  
$EndComp
$Comp
L RackZ80_Parts:628512 U3
U 1 1 606BD083
P 6100 2200
F 0 "U3" H 6350 3400 50  0000 C CNN
F 1 "628512" H 6350 3300 50  0000 C CNN
F 2 "rackz80_footprints:DIP-32_Socket_Wide" H 6100 1200 50  0001 C CNN
F 3 "https://cdn-reichelt.de/documents/datenblatt/A200/628512-55%24%23SAM.pdf" H 6100 3200 50  0001 C CNN
	1    6100 2200
	1    0    0    -1  
$EndComp
$Comp
L RackZ80_Parts:Z80CPU U4
U 1 1 606B3EBA
P 2400 2500
F 0 "U4" H 2650 4000 50  0000 C CNN
F 1 "Z80CPU" H 2650 3900 50  0000 C CNN
F 2 "rackz80_footprints:DIP-40_Socket_Wide" H 2400 3850 50  0001 C CNN
F 3 "http://datasheets.chipdb.org/Mostek/3880.pdf" H 2400 3850 50  0001 C CNN
	1    2400 2500
	1    0    0    -1  
$EndComp
NoConn ~ 10500 2700
...
U 1 1 61CDAC4A
P 1450 5150
F 0 "X1" H 1600 5550 50  0000 L CNN
F 1 "4MHz" H 1550 5450 50  0000 L CNN
F 2 "rackz80_footprints:DIP-14_Oscillator_Socket" H 1900 4800 50  0001 C CNN
F 3 "http://www.golledge.com/pdf/products/tcxos/gtxo14.pdf" H 1350 5150 50  0001 C CNN
	1    1450 5150
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 61CDB0B8
P 1450 5500
F 0 "#PWR023" H 1450 5250 50  0001 C CNN
...
U 1 1 61CDB0C2
P 1450 4800
F 0 "#PWR017" H 1450 4650 50  0001 C CNN
F 1 "+5V" H 1465 4973 50  0000 C CNN
...
U 1 1 6086EB2D
P 9100 5900
AR Path="/6161CDAA/6086EB2D" Ref="SW?"  Part="1" 
AR Path="/6086EB2D" Ref="SW2"  Part="1" 
F 0 "SW2" V 9500 5850 50  0000 L CNN
F 1 "SW_Reset" V 9400 5850 50  0000 L CNN
F 2 "rackz80_footprints:SW_MS-500" H 9100 6100 50  0001 C CNN
...
U 1 1 6086EB33
P 9550 5900
AR Path="/6161CDAA/6086EB33" Ref="C?"  Part="1" 
AR Path="/6086EB33" Ref="C1"  Part="1" 
F 0 "C1" H 9668 5946 50  0000 L CNN
F 1 "10uF" H 9668 5855 50  0000 L CNN
F 2 "Capacitor_THT:CP_Radial_D5.0mm_P2.50mm" H 9588 5750 50  0001 C CNN
...
U 1 1 6086EB39
P 9100 6150
AR Path="/6161CDAA/6086EB39" Ref="#PWR?"  Part="1" 
AR Path="/6086EB39" Ref="#PWR025"  Part="1" 
F 0 "#PWR025" H 9100 5900 50  0001 C CNN
...
U 1 1 6086EB3F
P 9550 6150
AR Path="/6161CDAA/6086EB3F" Ref="#PWR?"  Part="1" 
AR Path="/6086EB3F" Ref="#PWR026"  Part="1" 
F 0 "#PWR026" H 9550 5900 50  0001 C CNN
...
U 1 1 6086EB45
P 9550 5300
AR Path="/6161CDAA/6086EB45" Ref="#PWR?"  Part="1" 
AR Path="/6086EB45" Ref="#PWR022"  Part="1" 
F 0 "#PWR022" H 9550 5150 50  0001 C CNN
...
U 1 1 6086EB4B
P 9550 5500
AR Path="/6161CDAA/6086EB4B" Ref="R?"  Part="1" 
AR Path="/6086EB4B" Ref="R6"  Part="1" 
F 0 "R6" H 9620 5546 50  0000 L CNN
F 1 "4.7k" H 9620 5455 50  0000 L CNN
...
F 1 "100k" H 10020 5855 50  0000 L CNN
F 2 "Resistor_THT:R_Axial_DIN0207_L6.3mm_D2.5mm_P10.16mm_Horizontal" V 9880 5900 50  0001 C CNN
...
U 1 1 608A4B93
P 9950 6150
AR Path="/6161CDAA/608A4B93" Ref="#PWR?"  Part="1" 
AR Path="/608A4B93" Ref="#PWR027"  Part="1" 
F 0 "#PWR027" H 9950 5900 50  0001 C CNN
...
U 2 1 608D7BCF
P 10400 5700
F 0 "U8" H 10400 6017 50  0000 C CNN
F 1 "74LS14" H 10400 5926 50  0000 C CNN
F 2 "rackz80_footprints:DIP-14_Socket" H 10400 5700 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74LS14" H 10400 5700 50  0001 C CNN
	2    10400 5700
	1    0    0    -1  
$EndComp
...
F 1 "SW_Clock" H 2250 5050 50  0000 C CNN
F 2 "rackz80_footprints:SW_MS-500" H 2250 5250 50  0001 C CNN
...
U 1 1 60CF34E6
P 6650 5300
AR Path="/6161CDAA/60CF34E6" Ref="R?"  Part="1" 
AR Path="/60CF34E6" Ref="R5"  Part="1" 
F 0 "R5" H 6720 5346 50  0000 L CNN
F 1 "1k" H 6720 5255 50  0000 L CNN
F 2 "Resistor_THT:R_Axial_DIN0207_L6.3mm_D2.5mm_P10.16mm_Horizontal" V 6580 5300 50  0001 C CNN
...
U 1 1 60CF34F2
P 6650 5050
AR Path="/6161CDAA/60CF34F2" Ref="#PWR?"  Part="1" 
AR Path="/60CF34F2" Ref="#PWR021"  Part="1" 
F 0 "#PWR021" H 6650 4900 50  0001 C CNN
...
U 1 1 60D9D348
P 6150 5300
AR Path="/6161CDAA/60D9D348" Ref="R?"  Part="1" 
AR Path="/60D9D348" Ref="R4"  Part="1" 
F 0 "R4" H 6220 5346 50  0000 L CNN
F 1 "1k" H 6220 5255 50  0000 L CNN
F 2 "Resistor_THT:R_Axial_DIN0207_L6.3mm_D2.5mm_P10.16mm_Horizontal" V 6080 5300 50  0001 C CNN
...
U 1 1 60DE5689
P 6150 5050
AR Path="/6161CDAA/60DE5689" Ref="#PWR?"  Part="1" 
AR Path="/60DE5689" Ref="#PWR020"  Part="1" 
F 0 "#PWR020" H 6150 4900 50  0001 C CNN
...
U 1 1 60EF13C2
P 8100 3600
F 0 "U5" H 8350 4350 50  0000 C CNN
F 1 "74HC245" H 8350 4250 50  0000 C CNN
F 2 "rackz80_footprints:DIP-20_Socket" H 7850 4150 50  0001 C CNN
...
U 1 1 60EF4235
P 8100 4300
F 0 "#PWR013" H 8100 4050 50  0001 C CNN
...
U 3 1 608D9A2C
P 10600 6250
F 0 "U8" H 10600 6567 50  0000 C CNN
F 1 "74LS14" H 10600 6476 50  0000 C CNN
F 2 "rackz80_footprints:DIP-14_Socket" H 10600 6250 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74LS14" H 10600 6250 50  0001 C CNN
	3    10600 6250
	-1   0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	10900 5700 10900 6250
Wire Notes Line
	9000 5000 9000 6500
Wire Notes Line
	9000 6500 11000 6500
Wire Notes Line
	11000 6500 11000 5000
Wire Notes Line
...
U 1 1 612670E9
P 8100 5550
F 0 "U6" H 8350 6300 50  0000 C CNN
F 1 "74HC245" H 8350 6200 50  0000 C CNN
F 2 "rackz80_footprints:DIP-20_Socket" H 7850 6100 50  0001 C CNN
...
U 1 1 612676A3
P 8100 6250
F 0 "#PWR028" H 8100 6000 50  0001 C CNN
...
U 1 1 612A4BEC
P 8100 1650
F 0 "U1" H 8350 2400 50  0000 C CNN
F 1 "74HC245" H 8350 2300 50  0000 C CNN
F 2 "rackz80_footprints:DIP-20_Socket" H 7850 2200 50  0001 C CNN
...
U 1 1 612A51F0
P 8100 950
F 0 "#PWR02" H 8100 800 50  0001 C CNN
...
U 1 1 612A51FA
P 8100 2350
F 0 "#PWR07" H 8100 2100 50  0001 C CNN
...
U 1 1 616158AB
P 8500 6250
F 0 "#PWR029" H 8500 6000 50  0001 C CNN
...
U 1 1 61880C26
P 1650 6500
F 0 "U11" H 1650 6825 50  0000 C CNN
F 1 "74LS08" H 1650 6734 50  0000 C CNN
F 2 "rackz80_footprints:DIP-14_Socket" H 1650 6500 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74LS08" H 1650 6500 50  0001 C CNN
	1    1650 6500
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 607C4362
P 6650 5800
F 0 "D1" V 6689 5682 50  0000 R CNN
F 1 "LED" V 6598 5682 50  0000 R CNN
F 2 "rackz80_footprints:LED_Array_2" H 6650 5650 50  0001 C CNN
F 3 "https://cdn-reichelt.de/documents/datenblatt/A500/1801_1831_ENG_GER_TDS.pdf" H 6650 5650 50  0001 C CNN
	1    6650 5800
	0    -1   -1   0   
$EndComp
$Comp
...
U 2 1 607C5891
P 6150 5800
F 0 "D1" V 6189 5682 50  0000 R CNN
F 1 "LED" V 6098 5682 50  0000 R CNN
F 2 "rackz80_footprints:LED_Array_2" H 6150 5650 50  0001 C CNN
F 3 "https://cdn-reichelt.de/documents/datenblatt/A500/1801_1831_ENG_GER_TDS.pdf" H 6150 5650 50  0001 C CNN
	2    6150 5800
	0    -1   -1   0   
$EndComp
Wire Wire Line
...
U 1 1 60870265
P 9950 5500
F 0 "D2" V 9904 5580 50  0000 L CNN
F 1 "D" V 9995 5580 50  0000 L CNN
F 2 "Diode_THT:D_DO-35_SOD27_P10.16mm_Horizontal" H 9950 5500 50  0001 C CNN
...
U 1 1 608714D3
P 9950 5300
F 0 "#PWR0101" H 9950 5150 50  0001 C CNN
...
U 1 1 60714EC7
P 6150 7150
F 0 "RN1" V 6675 7150 50  0000 C CNN
F 1 "1k" V 6584 7150 50  0000 C CNN
F 2 "Resistor_THT:R_Array_SIP9" V 6625 7150 50  0001 C CNN
F 3 "http://www.vishay.com/docs/31509/csc.pdf" H 6150 7150 50  0001 C CNN
	1    6150 7150
	0    -1   -1   0   
$EndComp
...
~M1~ is low during Interrupt vector read.\n~RD~ is low when reading from I/O device.\nBut input only when reading from I/O.
$Comp
L 74xx:74LS32 U9
U 4 1 611B1CA5
P 1650 7200
F 0 "U9" H 1650 7525 50  0000 C CNN
F 1 "74LS32" H 1650 7434 50  0000 C CNN
F 2 "" H 1650 7200 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74LS32" H 1650 7200 50  0001 C CNN
	4    1650 7200
	1    0    0    -1  
$EndComp
Wire Wire Line
